...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://api.getlago.com/api/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.getlago.com/api/v1).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://api.getlago.com/api/v1")
        {
