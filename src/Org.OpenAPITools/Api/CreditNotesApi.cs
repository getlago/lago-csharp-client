...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ICreditNotesApi : IApiAccessor
    {
        ...
        /// <param name="id">ID of the existing Lago Credit note</param>
        /// <returns>ApiResponse of CreditNote</returns>
        ApiResponse<CreditNote> DownloadCreditNoteWithHttpInfo (Guid id);
        /// <summary>
        /// Find Credit notes
        /// </summary>
        /// <remarks>
        ...
        /// <param name="id">ID of the existing Lago Credit note</param>
        /// <returns>ApiResponse of CreditNote</returns>
        ApiResponse<CreditNote> VoidCreditNoteWithHttpInfo (Guid id);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CreditNote</returns>
        System.Threading.Tasks.Task<CreditNote> DownloadCreditNoteAsync (Guid id, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CreditNote)</returns>
        System.Threading.Tasks.Task<ApiResponse<CreditNote>> DownloadCreditNoteWithHttpInfoAsync (Guid id, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Find Credit notes
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CreditNote</returns>
        System.Threading.Tasks.Task<CreditNote> VoidCreditNoteAsync (Guid id, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CreditNote)</returns>
        System.Threading.Tasks.Task<ApiResponse<CreditNote>> VoidCreditNoteWithHttpInfoAsync (Guid id, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class CreditNotesApi : ICreditNotesApi
    {
        ...
        /// <param name="id">ID of the existing Lago Credit note</param>
        /// <returns>CreditNote</returns>
        public CreditNote DownloadCreditNote (Guid id)
        {
        ...
        /// <param name="id">ID of the existing Lago Credit note</param>
        /// <returns>ApiResponse of CreditNote</returns>
        public ApiResponse<CreditNote> DownloadCreditNoteWithHttpInfo (Guid id)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CreditNote</returns>
        public async System.Threading.Tasks.Task<CreditNote> DownloadCreditNoteAsync (Guid id, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CreditNote)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CreditNote>> DownloadCreditNoteWithHttpInfoAsync (Guid id, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling CreditNotesApi->DownloadCreditNote");
        ...
        /// <param name="id">ID of the existing Lago Credit note</param>
        /// <returns>CreditNote</returns>
        public CreditNote VoidCreditNote (Guid id)
        {
        ...
        /// <param name="id">ID of the existing Lago Credit note</param>
        /// <returns>ApiResponse of CreditNote</returns>
        public ApiResponse<CreditNote> VoidCreditNoteWithHttpInfo (Guid id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CreditNote</returns>
        public async System.Threading.Tasks.Task<CreditNote> VoidCreditNoteAsync (Guid id, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CreditNote)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CreditNote>> VoidCreditNoteWithHttpInfoAsync (Guid id, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling CreditNotesApi->VoidCreditNote");
