...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OrganizationInputOrganization :  IEquatable<OrganizationInputOrganization>, IValidatableObject
    {
        ...
        public OrganizationInputOrganization(string webhookUrl = default(string), string country = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string state = default(string), string zipode = default(string), string email = default(string), string city = default(string), string legalName = default(string), string legalNumber = default(string), string timezone = default(string), BillingConfigurationOrganization billingConfiguration = default(BillingConfigurationOrganization))
        {
