...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EventInput : IEquatable<EventInput>, IValidatableObject
    {
        ...
        public EventInput(EventInputEvent varEvent = default(EventInputEvent))
        {
            // to ensure "varEvent" is required (not null)
            if (varEvent == null)
            {
                throw new ArgumentNullException("varEvent is a required property for EventInput and cannot be null");
            }
        ...
        public EventInputEvent VarEvent { get; set; }
