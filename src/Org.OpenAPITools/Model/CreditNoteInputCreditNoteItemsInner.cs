...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreditNoteInputCreditNoteItemsInner :  IEquatable<CreditNoteInputCreditNoteItemsInner>, IValidatableObject
    {
        ...
        public CreditNoteInputCreditNoteItemsInner(Guid feeId = default(Guid), int amountCents = default(int))
        {
            ...
            if (feeId == null)
            {
                throw new InvalidDataException("feeId is a required property for CreditNoteInputCreditNoteItemsInner and cannot be null");
            }
            else
            {
                this.FeeId = feeId;
            ...
            if (amountCents == null)
            {
                throw new InvalidDataException("amountCents is a required property for CreditNoteInputCreditNoteItemsInner and cannot be null");
            }
            else
            {
        ...
        /// Gets or Sets FeeId
        /// </summary>
        [DataMember(Name="fee_id", EmitDefaultValue=true)]
