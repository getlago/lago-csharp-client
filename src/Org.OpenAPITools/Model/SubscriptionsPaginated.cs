...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SubscriptionsPaginated :  IEquatable<SubscriptionsPaginated>, IValidatableObject
    {
        ...
        public SubscriptionsPaginated(List<SubscriptionObject> subscriptions = default(List<SubscriptionObject>), PaginationMeta meta = default(PaginationMeta))
        {
            ...
            {
                throw new InvalidDataException("subscriptions is a required property for SubscriptionsPaginated and cannot be null");
            }
            else
            {
            ...
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for SubscriptionsPaginated and cannot be null");
            }
            else
            {
                this.Meta = meta;
