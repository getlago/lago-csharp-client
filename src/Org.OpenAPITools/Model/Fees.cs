...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Fees :  IEquatable<Fees>, IValidatableObject
    {
        ...
        public Fees(List<FeeObject> fees = default(List<FeeObject>))
        {
            // to ensure "fees" is required (not null)
            if (fees == null)
            {
                throw new InvalidDataException("fees is a required property for Fees and cannot be null");
            }
            else
            {
                this._Fees = fees;
        ...
        public List<FeeObject> _Fees { get; set; }
