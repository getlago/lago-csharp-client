...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApiResponseNotAllowed")]
    public partial class ApiResponseNotAllowed : IEquatable<ApiResponseNotAllowed>, IValidatableObject
    {
        ...
        public ApiResponseNotAllowed(int status = default(int), string error = default(string), string code = default(string))
        {
            ...
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for ApiResponseNotAllowed and cannot be null");
            }
            this.Error = error;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for ApiResponseNotAllowed and cannot be null");
            }
            this.Code = code;
        }
        ...
        /// Gets or Sets Error
        /// </summary>
        /// <example>Method Not Allowed</example>
