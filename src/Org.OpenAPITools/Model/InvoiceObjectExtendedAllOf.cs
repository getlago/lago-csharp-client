...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InvoiceObjectExtendedAllOf :  IEquatable<InvoiceObjectExtendedAllOf>, IValidatableObject
    {
        ...
        public InvoiceObjectExtendedAllOf(List<CreditObject> credits = default(List<CreditObject>), List<FeeObject> fees = default(List<FeeObject>), List<SubscriptionObject> subscriptions = default(List<SubscriptionObject>))
        {
            ...
            if (credits == null)
            {
                throw new InvalidDataException("credits is a required property for InvoiceObjectExtendedAllOf and cannot be null");
            }
            else
            {
            ...
            if (fees == null)
            {
                throw new InvalidDataException("fees is a required property for InvoiceObjectExtendedAllOf and cannot be null");
            }
            else
            {
                this.Fees = fees;
            ...
            {
                throw new InvalidDataException("subscriptions is a required property for InvoiceObjectExtendedAllOf and cannot be null");
            }
            else
            {
