...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CustomerInputCustomer :  IEquatable<CustomerInputCustomer>, IValidatableObject
    {
        ...
        public CustomerInputCustomer(string externalId = default(string), string name = default(string), string country = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string state = default(string), string zipcode = default(string), string email = default(string), string city = default(string), string url = default(string), string phone = default(string), string lagoUrl = default(string), string legalName = default(string), string legalNumber = default(string), string currency = default(string), string timezone = default(string), BillingConfigurationCustomer billingConfiguration = default(BillingConfigurationCustomer), List<CustomerInputCustomerMetadataInner> metadata = default(List<CustomerInputCustomerMetadataInner>))
        {
            // to ensure "externalId" is required (not null)
            if (externalId == null)
            {
                throw new InvalidDataException("externalId is a required property for CustomerInputCustomer and cannot be null");
            }
            else
            {
