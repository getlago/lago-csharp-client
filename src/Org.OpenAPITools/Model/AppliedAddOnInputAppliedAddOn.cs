...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AppliedAddOnInputAppliedAddOn :  IEquatable<AppliedAddOnInputAppliedAddOn>, IValidatableObject
    {
        ...
        public AppliedAddOnInputAppliedAddOn(string externalCustomerId = default(string), string addOnCode = default(string), int amountCents = default(int), string amountCurrency = default(string))
        {
            ...
            {
                throw new InvalidDataException("externalCustomerId is a required property for AppliedAddOnInputAppliedAddOn and cannot be null");
            }
            else
            {
            ...
            if (addOnCode == null)
            {
                throw new InvalidDataException("addOnCode is a required property for AppliedAddOnInputAppliedAddOn and cannot be null");
            }
            else
            {
