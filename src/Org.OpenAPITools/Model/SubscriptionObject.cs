...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SubscriptionObject :  IEquatable<SubscriptionObject>, IValidatableObject
    {
        ...
        public SubscriptionObject(string lagoId = default(string), string externalId = default(string), string lagoCustomerId = default(string), string externalCustomerId = default(string), string name = default(string), string planCode = default(string), StatusEnum? status = default(StatusEnum?), BillingTimeEnum? billingTime = default(BillingTimeEnum?), string subscriptionAt = default(string), string startedAt = default(string), string terminatedAt = default(string), string canceledAt = default(string), string createdAt = default(string), string previousPlanCode = default(string), string nextPlanCode = default(string), string downgradePlanDate = default(string))
        {
            this.LagoId = lagoId;
        ...
        public string DowngradePlanDate { get; set; }
