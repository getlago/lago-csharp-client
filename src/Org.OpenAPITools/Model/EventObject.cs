...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EventObject : IEquatable<EventObject>, IValidatableObject
    {
        ...
        public EventObject(Guid lagoId = default(Guid), string transactionId = default(string), Guid lagoCustomerId = default(Guid), string externalCustomerId = default(string), string code = default(string), DateTime timestamp = default(DateTime), Object properties = default(Object), Guid lagoSubscriptionId = default(Guid), string externalSubscriptionId = default(string), DateTime createdAt = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("transactionId is a required property for EventObject and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("externalCustomerId is a required property for EventObject and cannot be null");
            }
            this.ExternalCustomerId = externalCustomerId;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for EventObject and cannot be null");
            }
            this.Code = code;
            ...
            {
                throw new ArgumentNullException("externalSubscriptionId is a required property for EventObject and cannot be null");
            }
        ...
        /// </summary>
        /// <example>1a901a90-1a90-1a90-1a90-1a901a901a90</example>
        [DataMember(Name = "lago_subscription_id", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <example>123456</example>
        [DataMember(Name = "external_subscription_id", IsRequired = true, EmitDefaultValue = true)]
