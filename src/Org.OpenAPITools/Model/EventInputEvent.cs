...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EventInputEvent :  IEquatable<EventInputEvent>, IValidatableObject
    {
        ...
        public EventInputEvent(string transactionId = default(string), string externalCustomerId = default(string), string code = default(string), int timestamp = default(int), string externalSubscriptionId = default(string), Object properties = default(Object))
        {
            ...
            {
                throw new InvalidDataException("transactionId is a required property for EventInputEvent and cannot be null");
            }
            else
            {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for EventInputEvent and cannot be null");
            }
            else
            {
                this.Code = code;
