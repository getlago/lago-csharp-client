...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AddOnsPaginated :  IEquatable<AddOnsPaginated>, IValidatableObject
    {
        ...
        public AddOnsPaginated(List<AddOnObject> addOns = default(List<AddOnObject>), PaginationMeta meta = default(PaginationMeta))
        {
            ...
            if (addOns == null)
            {
                throw new InvalidDataException("addOns is a required property for AddOnsPaginated and cannot be null");
            }
            else
            {
                this.AddOns = addOns;
            ...
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for AddOnsPaginated and cannot be null");
            }
            else
            {
                this.Meta = meta;
        ...
        /// Gets or Sets AddOns
        /// </summary>
        [DataMember(Name="add_ons", EmitDefaultValue=true)]
