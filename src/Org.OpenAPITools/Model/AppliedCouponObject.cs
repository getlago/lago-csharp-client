...
namespace Org.OpenAPITools.Model
{
    ...
    /// AppliedCouponObject
    /// </summary>
    [DataContract(Name = "AppliedCouponObject")]
    public partial class AppliedCouponObject : IEquatable<AppliedCouponObject>, IValidatableObject
    {
        ...
        public AppliedCouponObject(Guid lagoId = default(Guid), Guid lagoCouponId = default(Guid), string couponCode = default(string), Guid lagoCustomerId = default(Guid), string externalCustomerId = default(string), StatusEnum status = default(StatusEnum), int amountCents = default(int), int amountCentsRemaining = default(int), string amountCurrency = default(string), decimal percentageRate = default(decimal), FrequencyEnum frequency = default(FrequencyEnum), int frequencyDuration = default(int), int frequencyDurationRemaining = default(int), DateTime expirationAt = default(DateTime), DateTime createdAt = default(DateTime), DateTime terminatedAt = default(DateTime))
        {
            ...
            if (couponCode == null)
            {
                throw new ArgumentNullException("couponCode is a required property for AppliedCouponObject and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("externalCustomerId is a required property for AppliedCouponObject and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("amountCurrency is a required property for AppliedCouponObject and cannot be null");
            }
