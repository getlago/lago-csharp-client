...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CustomerObject :  IEquatable<CustomerObject>, IValidatableObject
    {
        ...
        public CustomerObject(Guid lagoId = default(Guid), string externalId = default(string), string name = default(string), int sequentialId = default(int), string slug = default(string), DateTime createdAt = default(DateTime), string country = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string state = default(string), string zipcode = default(string), string email = default(string), string city = default(string), string url = default(string), string phone = default(string), string lagoUrl = default(string), string legalName = default(string), string legalNumber = default(string), string currency = default(string), string timezone = default(string), string applicableTimezone = default(string), BillingConfigurationCustomer billingConfiguration = default(BillingConfigurationCustomer), List<CustomerMetadataObject> metadata = default(List<CustomerMetadataObject>))
        {
            // to ensure "lagoId" is required (not null)
            if (lagoId == null)
            {
                throw new InvalidDataException("lagoId is a required property for CustomerObject and cannot be null");
            }
            else
            {
                this.LagoId = lagoId;
            ...
            if (externalId == null)
            {
                throw new InvalidDataException("externalId is a required property for CustomerObject and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sequentialId is a required property for CustomerObject and cannot be null");
            }
            else
            {
            ...
            if (slug == null)
            {
                throw new InvalidDataException("slug is a required property for CustomerObject and cannot be null");
            }
            else
            {
                this.Slug = slug;
