...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CustomerObject :  IEquatable<CustomerObject>, IValidatableObject
    {
        ...
        public CustomerObject(string lagoId = default(string), string externalId = default(string), string name = default(string), int sequentialId = default(int), string slug = default(string), string createdAt = default(string), string country = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string state = default(string), string zipode = default(string), string email = default(string), string city = default(string), string url = default(string), string phone = default(string), string lagoUrl = default(string), string legalName = default(string), string legalNumber = default(string), string currency = default(string), string timezone = default(string), string applicableTimezone = default(string), BillingConfigurationCustomer billingConfiguration = default(BillingConfigurationCustomer))
        {
            this.LagoId = lagoId;
