...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApiResponseForbidden")]
    public partial class ApiResponseForbidden : IEquatable<ApiResponseForbidden>, IValidatableObject
    {
        ...
        public ApiResponseForbidden(int status = default(int), string error = default(string), string code = default(string))
        {
            ...
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for ApiResponseForbidden and cannot be null");
            }
            this.Error = error;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for ApiResponseForbidden and cannot be null");
            }
            this.Code = code;
        }
        ...
        /// Gets or Sets Code
        /// </summary>
        /// <example>feature_unavailable</example>
