...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ChargeUsageObjectBillableMetric :  IEquatable<ChargeUsageObjectBillableMetric>, IValidatableObject
    {
        ...
        public ChargeUsageObjectBillableMetric(string lagoId = default(string), string name = default(string), string code = default(string), AggregationTypeEnum? aggregationType = default(AggregationTypeEnum?))
        {
            this.LagoId = lagoId;
            this.Name = name;
            this.Code = code;
