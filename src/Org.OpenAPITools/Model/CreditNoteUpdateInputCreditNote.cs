...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreditNoteUpdateInputCreditNote :  IEquatable<CreditNoteUpdateInputCreditNote>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Refund status</value>
        [DataMember(Name="refund_status", EmitDefaultValue=true)]
        ...
        protected CreditNoteUpdateInputCreditNote() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditNoteUpdateInputCreditNote" /> class.
        /// </summary>
        /// <param name="refundStatus">Refund status (required).</param>
        public CreditNoteUpdateInputCreditNote(RefundStatusEnum refundStatus = default(RefundStatusEnum))
        {
            // to ensure "refundStatus" is required (not null)
            if (refundStatus == null)
            {
                throw new InvalidDataException("refundStatus is a required property for CreditNoteUpdateInputCreditNote and cannot be null");
            }
            else
            {
