...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AddOnObject : IEquatable<AddOnObject>, IValidatableObject
    {
        ...
        public AddOnObject(Guid lagoId = default(Guid), string name = default(string), string code = default(string), string description = default(string), DateTime createdAt = default(DateTime), int amountCents = default(int), string amountCurrency = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AddOnObject and cannot be null");
            }
            this.Name = name;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for AddOnObject and cannot be null");
            }
            this.Code = code;
            ...
            {
                throw new ArgumentNullException("amountCurrency is a required property for AddOnObject and cannot be null");
            }
