...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AddOnObject :  IEquatable<AddOnObject>, IValidatableObject
    {
        ...
        public AddOnObject(string lagoId = default(string), string name = default(string), string code = default(string), string description = default(string), string createdAt = default(string), int amountCents = default(int), string amountCurrency = default(string))
        {
            this.LagoId = lagoId;
            this.Name = name;
            this.Code = code;
