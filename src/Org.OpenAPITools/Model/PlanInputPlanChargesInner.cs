...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PlanInputPlanChargesInner :  IEquatable<PlanInputPlanChargesInner>, IValidatableObject
    {
        ...
        public PlanInputPlanChargesInner(Guid id = default(Guid), Guid billableMetricId = default(Guid), ChargeModelEnum? chargeModel = default(ChargeModelEnum?), bool instant = default(bool), int minAmountCents = default(int), Object properties = default(Object), List<PlanInputPlanChargesInnerGroupPropertiesInner> groupProperties = default(List<PlanInputPlanChargesInnerGroupPropertiesInner>))
        {
            this.Id = id;
