...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BillableMetricObject :  IEquatable<BillableMetricObject>, IValidatableObject
    {
        ...
        /// <param name="activeSubscriptionsCount">activeSubscriptionsCount.</param>
        /// <param name="draftInvoicesCount">draftInvoicesCount.</param>
        public BillableMetricObject(string lagoId = default(string), string name = default(string), string code = default(string), string description = default(string), string createdAt = default(string), string fieldName = default(string), AggregationTypeEnum? aggregationType = default(AggregationTypeEnum?), BillableMetricGroup group = default(BillableMetricGroup), int activeSubscriptionsCount = default(int), int draftInvoicesCount = default(int))
        {
            this.LagoId = lagoId;
            this.Name = name;
            this.Code = code;
        ...
        /// </summary>
        [DataMember(Name="active_subscriptions_count", EmitDefaultValue=false)]
        public int ActiveSubscriptionsCount { get; set; }

        /// <summary>
        /// Gets or Sets DraftInvoicesCount
        /// </summary>
        [DataMember(Name="draft_invoices_count", EmitDefaultValue=false)]
