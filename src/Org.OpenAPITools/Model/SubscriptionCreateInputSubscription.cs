...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SubscriptionCreateInputSubscription :  IEquatable<SubscriptionCreateInputSubscription>, IValidatableObject
    {
        ...
        public SubscriptionCreateInputSubscription(string externalCustomerId = default(string), string planCode = default(string), string name = default(string), string externalId = default(string), BillingTimeEnum? billingTime = default(BillingTimeEnum?), DateTime subscriptionAt = default(DateTime))
        {
            ...
            {
                throw new InvalidDataException("externalCustomerId is a required property for SubscriptionCreateInputSubscription and cannot be null");
            }
            else
            {
            ...
            if (planCode == null)
            {
                throw new InvalidDataException("planCode is a required property for SubscriptionCreateInputSubscription and cannot be null");
            }
            else
            {
            ...
            if (externalId == null)
            {
                throw new InvalidDataException("externalId is a required property for SubscriptionCreateInputSubscription and cannot be null");
            }
            else
            {
