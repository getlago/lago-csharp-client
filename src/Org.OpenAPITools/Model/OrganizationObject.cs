...
namespace Org.OpenAPITools.Model
{
    ...
    /// OrganizationObject
    /// </summary>
    [DataContract(Name = "OrganizationObject")]
    public partial class OrganizationObject : IEquatable<OrganizationObject>, IValidatableObject
    {
        ...
        public OrganizationObject(Guid lagoId = default(Guid), string name = default(string), DateTime createdAt = default(DateTime), string webhookUrl = default(string), string country = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string state = default(string), string zipcode = default(string), string email = default(string), string city = default(string), string legalName = default(string), string legalNumber = default(string), string taxIdentificationNumber = default(string), string timezone = default(string), BillingConfigurationOrganization billingConfiguration = default(BillingConfigurationOrganization))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for OrganizationObject and cannot be null");
            }
            this.Name = name;
