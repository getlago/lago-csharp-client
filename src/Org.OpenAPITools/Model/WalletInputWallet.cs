...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WalletInputWallet :  IEquatable<WalletInputWallet>, IValidatableObject
    {
        ...
        public WalletInputWallet(string name = default(string), decimal rateAmount = default(decimal), string currency = default(string), decimal paidCredits = default(decimal), decimal grantedCredits = default(decimal), string externalCustomerId = default(string), string expirationAt = default(string))
        {
            this.Name = name;
