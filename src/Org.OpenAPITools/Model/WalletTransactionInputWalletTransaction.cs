...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WalletTransactionInputWalletTransaction :  IEquatable<WalletTransactionInputWalletTransaction>, IValidatableObject
    {
        ...
        public WalletTransactionInputWalletTransaction(string walletId = default(string), decimal paidCredits = default(decimal), decimal grantedCredits = default(decimal))
        {
