...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AppliedCouponObjectExtended :  IEquatable<AppliedCouponObjectExtended>, IValidatableObject
    {
        ...
        public AppliedCouponObjectExtended(Guid lagoId = default(Guid), Guid lagoCouponId = default(Guid), string couponCode = default(string), Guid lagoCustomerId = default(Guid), string externalCustomerId = default(string), StatusEnum status = default(StatusEnum), int amountCents = default(int), int amountCentsRemaining = default(int), string amountCurrency = default(string), decimal percentageRate = default(decimal), FrequencyEnum frequency = default(FrequencyEnum), int frequencyDuration = default(int), int frequencyDurationRemaining = default(int), DateTime expirationAt = default(DateTime), DateTime createdAt = default(DateTime), DateTime terminatedAt = default(DateTime), List<CreditObject> credits = default(List<CreditObject>))
        {
            ...
            if (lagoId == null)
            {
                throw new InvalidDataException("lagoId is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
                this.LagoId = lagoId;
            ...
            {
                throw new InvalidDataException("lagoCouponId is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
            ...
            if (couponCode == null)
            {
                throw new InvalidDataException("couponCode is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("lagoCustomerId is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("externalCustomerId is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (amountCents == null)
            {
                throw new InvalidDataException("amountCents is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("amountCurrency is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
            ...
            if (frequency == null)
            {
                throw new InvalidDataException("frequency is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
            ...
            if (createdAt == null)
            {
                throw new InvalidDataException("createdAt is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
            ...
            if (credits == null)
            {
                throw new InvalidDataException("credits is a required property for AppliedCouponObjectExtended and cannot be null");
            }
            else
            {
