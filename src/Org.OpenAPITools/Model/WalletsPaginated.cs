...
namespace Org.OpenAPITools.Model
{
    ...
    /// WalletsPaginated
    /// </summary>
    [DataContract(Name = "WalletsPaginated")]
    public partial class WalletsPaginated : IEquatable<WalletsPaginated>, IValidatableObject
    {
        ...
        public WalletsPaginated(List<WalletObject> wallets = default(List<WalletObject>), PaginationMeta meta = default(PaginationMeta))
        {
            ...
            if (wallets == null)
            {
                throw new ArgumentNullException("wallets is a required property for WalletsPaginated and cannot be null");
            }
            this.Wallets = wallets;
            // to ensure "meta" is required (not null)
            if (meta == null)
            {
                throw new ArgumentNullException("meta is a required property for WalletsPaginated and cannot be null");
            }
            this.Meta = meta;
        }
