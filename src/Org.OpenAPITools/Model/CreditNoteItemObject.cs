...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreditNoteItemObject")]
    public partial class CreditNoteItemObject : IEquatable<CreditNoteItemObject>, IValidatableObject
    {
        ...
        public CreditNoteItemObject(Guid lagoId = default(Guid), int amountCents = default(int), string amountCurrency = default(string), FeeObject fee = default(FeeObject))
        {
            ...
            {
                throw new ArgumentNullException("amountCurrency is a required property for CreditNoteItemObject and cannot be null");
            }
            this.AmountCurrency = amountCurrency;
            // to ensure "fee" is required (not null)
            if (fee == null)
            {
                throw new ArgumentNullException("fee is a required property for CreditNoteItemObject and cannot be null");
            }
            this.Fee = fee;
        }
