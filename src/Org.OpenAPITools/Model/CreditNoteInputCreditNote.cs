...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreditNoteInputCreditNote :  IEquatable<CreditNoteInputCreditNote>, IValidatableObject
    {
        ...
        public CreditNoteInputCreditNote(Guid invoiceId = default(Guid), ReasonEnum reason = default(ReasonEnum), string description = default(string), int creditAmountCents = default(int), int refundAmountCents = default(int), List<CreditNoteInputCreditNoteItemsInner> items = default(List<CreditNoteInputCreditNoteItemsInner>))
        {
            ...
            if (invoiceId == null)
            {
                throw new InvalidDataException("invoiceId is a required property for CreditNoteInputCreditNote and cannot be null");
            }
            else
            {
            ...
            if (reason == null)
            {
                throw new InvalidDataException("reason is a required property for CreditNoteInputCreditNote and cannot be null");
            }
            else
            {
                this.Reason = reason;
            ...
            {
                throw new InvalidDataException("creditAmountCents is a required property for CreditNoteInputCreditNote and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("refundAmountCents is a required property for CreditNoteInputCreditNote and cannot be null");
            }
            else
            {
            ...
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for CreditNoteInputCreditNote and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        /// </summary>
        [DataMember(Name="invoice_id", EmitDefaultValue=true)]
