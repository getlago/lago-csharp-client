...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchEventInput_event")]
    public partial class BatchEventInputEvent : IEquatable<BatchEventInputEvent>, IValidatableObject
    {
        ...
        public BatchEventInputEvent(string transactionId = default(string), string externalCustomerId = default(string), string code = default(string), int timestamp = default(int), List<string> externalSubscriptionIds = default(List<string>), Object properties = default(Object))
        {
            ...
            {
                throw new ArgumentNullException("transactionId is a required property for BatchEventInputEvent and cannot be null");
            }
            this.TransactionId = transactionId;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for BatchEventInputEvent and cannot be null");
            }
            this.Code = code;
            // to ensure "externalSubscriptionIds" is required (not null)
            if (externalSubscriptionIds == null)
            {
                throw new ArgumentNullException("externalSubscriptionIds is a required property for BatchEventInputEvent and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "external_subscription_ids", IsRequired = true, EmitDefaultValue = true)]
