...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ChargeUsageObject :  IEquatable<ChargeUsageObject>, IValidatableObject
    {
        ...
        public ChargeUsageObject(decimal units = default(decimal), int amountCents = default(int), string amountCurrency = default(string), ChargeUsageObjectCharge charge = default(ChargeUsageObjectCharge), ChargeUsageObjectBillableMetric billableMetric = default(ChargeUsageObjectBillableMetric), List<ChargeUsageObjectGroupsInner> groups = default(List<ChargeUsageObjectGroupsInner>))
        {
            ...
            if (units == null)
            {
                throw new InvalidDataException("units is a required property for ChargeUsageObject and cannot be null");
            }
            else
            {
                this.Units = units;
            ...
            if (amountCents == null)
            {
                throw new InvalidDataException("amountCents is a required property for ChargeUsageObject and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("amountCurrency is a required property for ChargeUsageObject and cannot be null");
            }
            else
            {
            ...
            if (charge == null)
            {
                throw new InvalidDataException("charge is a required property for ChargeUsageObject and cannot be null");
            }
            else
            {
                this.Charge = charge;
            ...
            {
                throw new InvalidDataException("billableMetric is a required property for ChargeUsageObject and cannot be null");
            }
            else
            {
            ...
            if (groups == null)
            {
                throw new InvalidDataException("groups is a required property for ChargeUsageObject and cannot be null");
            }
            else
            {
                this.Groups = groups;
